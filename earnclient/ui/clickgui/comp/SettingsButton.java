...
public class SettingsButton extends GuiButton
{
    ...
    public SettingsButton(final int buttonId, final int x, final int y, final int widthIn, final int heightIn, final String buttonText, final ResourceLocation image) {
