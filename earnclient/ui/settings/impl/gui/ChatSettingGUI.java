...
public class ChatSettingGUI extends GuiScreen
{
    ArrayList<SettingButton> settingButtons;
    
    public ChatSettingGUI() {
    ...
    public void initGui() {
        ...
        final Chat chat = HudManager.chat;
        final SettingsManager settingsManager = EarnClient.INSTANCE.settingsManager;
        settingButtons.add(new SettingButton(x, y, w, h, chat, SettingsManager.chatBackground));
    }
